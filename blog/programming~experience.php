...
<html lang="en">
    <head>
        ...
        <title>Programming Expirience</title>
    </head>
    ...
    <body>
        ...
        <article class="page_content">
            <p>
                Back in Russia I used to take programming courses for 4 years in a private school in addition to my regular education.
                At that time I learned the basics of programming on Python, C++, C#.
                I also studied video game development on Unreal Engine 4 Blueprints and Unity 3d.
            </p>
        </article>
