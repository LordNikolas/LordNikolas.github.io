...
<html lang="en">
    <head>
        ...
        <title>Pitch Feedback, Code</title>
    </head>
    ...
    <body>
        ...
        <article class="page_content">
            <img class="article_page_image_attachment" src="../images/pitch_feedback_code1.png" alt="pitch_feedback_code1">
            <img class="article_page_image_attachment" src="../images/pitch_feedback_code2.png" alt="pitch_feedback_code2">
            <p>
                The pitch evaluation made by Elio Tolhoek concludes that 
                my website lacks blog articles, dashboard progress bar, 
                HTML5 elements for easier search access and lowercase filenames.
            </p>
        </article>
